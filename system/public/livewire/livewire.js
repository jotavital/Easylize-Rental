...
!function (global, factory) {
  ...
  var Connection = function () {
    ...
    return _createClass(Connection, [{
      ...
      value: function value(message, status) {
        return message.component.messageSendFailed(), store$2.onErrorCallback(status);
      }
    }, {
        ...
        fetch("".concat(window.livewire_app_url, "/livewire/message/").concat(payload.fingerprint.name), {
          ...
          if (response.ok) response.text().then(function (response) {
            ...
            if (419 === response.status) {
              ...
              store$2.sessionHasExpired = !0, _this.showExpiredMessage();
  ...
  var LivewireStateManager = {
    ...
    updateState: function updateState(method, url, response, component) {
      ...
      try {
        "undefined" != decodeURIComponent(url) && (url = decodeURIComponent(url).replaceAll(" ", "+").replaceAll("\\", "%5C")), history[method](fullstateObject, "", url);
      } catch (error) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./vendor/livewire/livewire/dist/livewire.js");
/******/ 	
/******/ })()
;