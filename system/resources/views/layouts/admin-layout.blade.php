                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-animation-speed="500" data-accordion="false">
                        <li class="nav-item @yield('frota-menu-open')">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('veiculos.index') }}" class="nav-link @yield('todos-veiculos-menu-active')">
                                        <i class="fas fa-list-alt nav-icon"></i>
                                        <p>Todos os veículos</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('marcas.index') }}" class="nav-link @yield('marcas-veiculos-menu-active')">
                        ...
                        <li class="nav-item @yield('clientes-menu-open')">
                            <a href="#" class="nav-link @yield('clientes-menu-active')">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('clientes.create') }}" class="nav-link @yield('novo-cliente-menu-active')">
                                        <i class="fas fa-user-plus nav-icon"></i>
                                        <p>Novo cliente</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('clientes.index') }}" class="nav-link @yield('todos-clientes-menu-active')">
                                        <i class="fas fa-list-alt nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href=" {{ route('configuracoes.index') }} " class="nav-link @yield('configuracoes-menu-active')">
