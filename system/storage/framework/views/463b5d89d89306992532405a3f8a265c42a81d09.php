...
<?php endif; ?>
        ...
        <form action=" <?php echo e(route('alugueis.store')); ?> " method="POST" class="col-12 needs-validation" enctype='multipart/form-data' novalidate>
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\wamp64\www\Easylize-Rental\system\resources\views/livewire/alugueis/alugueis.blade.php ENDPATH**/ ?>