...
} elseif ($_instance->childHasBeenRendered('cQHUA71')) {
    $componentId = $_instance->getRenderedChildComponentId('cQHUA71');
    $componentTag = $_instance->getRenderedChildComponentTagName('cQHUA71');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cQHUA71');
} else {
    $response = \Livewire\Livewire::mount('modelo-veiculo.input-imagens-modelo', ['modelo' => $modelo]);
    $html = $response->html();
    $_instance->logRenderedChild('cQHUA71', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <hr>
...
} elseif ($_instance->childHasBeenRendered('JF53iWL')) {
    $componentId = $_instance->getRenderedChildComponentId('JF53iWL');
    $componentTag = $_instance->getRenderedChildComponentTagName('JF53iWL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JF53iWL');
} else {
    $response = \Livewire\Livewire::mount('modelo-veiculo.card-fotos-modelo-veiculo', ['modelo' => $modelo]);
    $html = $response->html();
    $_instance->logRenderedChild('JF53iWL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
