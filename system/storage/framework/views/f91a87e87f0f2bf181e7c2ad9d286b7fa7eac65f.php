<div class="">
    <div class="row">
        <div class="col-md-4 col-sm-6 col-12">
            <a href="<?php echo e(route('alugueis.index')); ?>" class="text-dark">
                <div class="col-12 info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <h3 class="info-box-number"><?php echo e($qtdAlugueisEmAndamento); ?></h3>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo e(route('alugueis.index')); ?>" class="text-dark">
                <div class="col-12 info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <h3 class="info-box-number"><?php echo e($qtdAlugueisPagamentoPendente); ?></h3>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="<?php echo e(route('alugueis.index')); ?>" class="text-dark">
                <div class="col-12 info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <h3 class="info-box-number"><?php echo e($qtdAlugueisDevolucaoHoje); ?></h3>
                    </div>
                </div>
            </a>
        </div>
